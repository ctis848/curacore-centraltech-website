    ...
    <footer className="bg-teal-950 text-white py-16 mt-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-12">
          {/* Column 1: Company */}
          <div className="md:border-r md:border-teal-800 md:pr-6">
          ...
          <div className="md:border-r md:border-teal-800 md:pr-6">
            ...
            <p className="text-teal-200 leading-relaxed break-words max-w-full">
              Central Tech Information Systems Ltd.<br />
              Lagos, Nigeria<br />
              +234 805 931 8564<br />
              <span className="block mt-2">info@centraltechinformationsystems.com</span>
            </p>
          </div>
