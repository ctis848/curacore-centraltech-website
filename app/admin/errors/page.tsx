...
export default function ErrorMonitoringPage() {
  ...
  useEffect(() => {
    Promise.all([
      fetch("/admin/api/errors").then((r) => r.json()),
  ...
  if (loading) {
    return <p className="p-6 dark:text-white">Loading error logs...</p>;
  }

  return (
    <RequireRole role="ADMIN">
      <div className="space-y-6">
        <h1 className="text-2xl font-bold dark:text-white">Error Monitoring</h1>
