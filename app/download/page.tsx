      ...
      <section className="py-24 px-6 md:px-10 max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          {[
            ...
            <div
              key={i}
              className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-teal-200 flex flex-col justify-between"
            >
              <div>
                <div className="text-5xl mb-4">{d.icon}</div>
                <h3 className="text-2xl font-bold text-teal-800 mb-3">{d.title}</h3>
                <p className="text-gray-700 leading-relaxed mb-6">{d.desc}</p>
              </div>

              <a
                href={d.link}
                className="bg-teal-700 text-white text-center py-3 rounded-xl font-semibold hover:bg-teal-800 transition"
                download
              >
                {d.btn}
              </a>
