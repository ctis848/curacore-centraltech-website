...
// NO OTHER STRIPE IMPORTS ALLOWED — NOT EVEN COMMENTED
...
export default function BuyPage() {
  ...
  const redirectToCheckout = async (priceId: string, planName: string) => {
    setLoading(true);
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-10 hover:scale-105 transition-all">
            ...
            <p className="text-6xl font-bold text-gray-900 mb-2">$11<span className="text-2xl">/mo</span></p>
            <button
              onClick={() => redirectToCheckout('price_1SaN5sECEzFismm5enqBvUCk', 'Starter')}
              disabled={loading}
              className="w-full mt-8 bg-blue-900 text-white py-5 rounded-xl text-xl font-bold hover:bg-blue-800 disabled:opacity-50"
            >
              {loading ? 'Loading...' : 'Buy Starter'}
            </button>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-900 to-blue-800 text-white rounded-3xl shadow-2xl p-12 transform scale-110 border-8 border-yellow-400 relative">
            ...
            <p className="text-7xl font-bold mb-2">$15<span className="text-3xl">/mo</span></p>
            <button
              onClick={() => redirectToCheckout('price_1SaNH7ECEzFismm5X0PzxHOT', 'Pro')}
              disabled={loading}
              className="w-full mt-10 bg-white text-blue-900 py-6 rounded-xl text-2xl font-bold hover:bg-gray-100 disabled:opacity-50"
            >
              {loading ? 'Loading...' : 'Buy Pro Now'}
            </button>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-600 to-green-700 text-white rounded-3xl shadow-2xl p-10 hover:scale-105 transition-all">
            ...
            <button
              onClick={() => redirectToCheckout('price_1SaNJmECEzFismm5fDBhO46P', 'Lifetime')}
              disabled={loading}
            ...
            >
              {loading ? 'Loading...' : 'Buy Lifetime Access'}
            </button>
          </div>
