...
// ← ONLY THIS IMPORT — NO "import Stripe from 'stripe'" ANYWHERE
...
export default function BuyLicense() {
  ...
  const handleCheckout = async (priceId: string, planName: string) => {
    ...
    if (!stripe) {
      alert('Stripe failed to load. Check your publishable key in Netlify.');
      setLoading(null);
      return;
    }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-10 hover:scale-105 transition-all">
            ...
            <button
              ...
              disabled={!!loading}
              className="w-full bg-blue-900 text-white py-5 rounded-xl text-xl font-bold hover:bg-blue-800 disabled:opacity-60"
            >
          ...
          <div className="bg-gradient-to-br from-blue-900 to-blue-800 text-white rounded-3xl shadow-2xl p-12 transform scale-110 border-8 border-yellow-400 relative">
            ...
            <button
              ...
              disabled={!!loading}
              className="w-full bg-white text-blue-900 py-5 rounded-xl text-2xl font-bold hover:bg-gray-100 disabled:opacity-60"
            >
          ...
          <div className="bg-gradient-to-br from-green-600 to-green-700 text-white rounded-3xl shadow-2xl p-10 hover:scale-105 transition-all">
            ...
            <button
              ...
              disabled={!!loading}
              className="w-full bg-yellow-400 text-blue-900 py-5 rounded-xl text-xl font-bold hover:bg-yellow-300 disabled:opacity-60"
            >
