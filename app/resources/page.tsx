        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <Link href="/support" className="block group">
              <div className="bg-white rounded-3xl shadow-xl p-10 hover:shadow-2xl hover:scale-105 transition-all duration-300 h-full flex flex-col border border-teal-100">
                ...
                <span className="text-teal-600 font-bold mt-6 text-center group-hover:text-yellow-400 transition">
                  Go to Support →
                </span>
              </div>
            </Link>
      ...
      <section className="py-24 px-6 bg-teal-800 text-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-2xl mb-12 max-w-3xl mx-auto">
            Our expert support team is ready to assist you 24/7
          </p>
          <Link
            href="/support"
